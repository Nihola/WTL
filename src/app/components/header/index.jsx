      ...
      <nav className='navbar fixed top-0 left-0 w-full bg-white shadow-lg z-50 border-b border-blue-100'>
        <div className='max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-20'>
            ...
            <Link
              href="/"
              className='flex items-center gap-4 text-black hover:text-gray-800 transition-colors duration-300 min-w-fit'
              aria-label="WTL home"
            >
            ...
            <div className='hidden md:flex items-center gap-6 lg:gap-8 flex-1 justify-end'>
              ...
              <button className='text-white bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 whitespace-nowrap ml-4'>
                ...
                <div className='flex items-center gap-2'>
                  {['/uz.jpg', '/ru.png', '/en.jpeg'].map((src, i) => (
                    <button
                      key={i}
                      aria-label={`Til ${i + 1}`}
                      className='w-8 h-8 rounded-full overflow-hidden border-2 border-blue-500 hover:opacity-75 transition-opacity'
                    >
          ...
          >
            ...
            >
              ...
              <div className='px-6 py-3'>
                <button className="w-full text-white bg-blue-500 hover:bg-blue-600 px-6 py-3 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105">
                  Biz bilan bog'laning
                </button>
              </div>
            </div>
